...
@Component({
  selector: 'app-ham-canvas',
  standalone: true,
    imports: [
        DynamicCanvasDirective
    ],
  templateUrl: './ham-canvas.component.html',
  styleUrl: './ham-canvas.component.scss'
})
export class HamCanvasComponent implements OnInit, AfterViewInit, OnDestroy {
